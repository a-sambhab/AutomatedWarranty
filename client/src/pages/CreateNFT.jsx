  ...
  const{add} = useParams();
    ...
    const UploadImage = async (e) => {
     ...
     e.preventDefault()
          ...
          attributes: [
            {
                "display_type": "date", 
                "trait_type": "expiry", 
                "value":Date.now()+expiry*31557600000
      ...
      const expirytime = expiry*31557600
       await createNFT(Contract,finalResult,sellerI,productId,customer.toLowerCase(),expirytime,res,account.currentAccount);
        alert('NFT created')
        setTimeout(function () {
